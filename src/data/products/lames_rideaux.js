const lamesRideaux = [
  {
    ...
    specifications: [
      "Capacité: 400 kg",
      "Type: Central à double induit",
      "Mouvement fluide et silencieux",
      "Installation facile",
      "Idéal pour usage commercial et industriel"
    ]
  },
  {
  ...
  },
  {
    ...
    category: "lames_rideaux",
    specifications: [
      "Pour toute demande spécifique, consulter l'équipe technico-commerciale",
      "Tôle galvanisée ou laquée de forte épaisseur",
      "Système de fixation robuste",
      "Accès pour maintenance",
      "Options: isolation phonique, trappe de visite"
    ]
  },
  {
    id: "flasque",
    ...
    specifications: [
      "Pour toute demande spécifique, consulter l'équipe technico-commerciale",
      "Épaisseur: 2mm 350350 à 3mm 400400",
      "Paliers auto-lubrifiants intégrés",
      "Multiples points de fixation",
      "Compatible avec différents systèmes de motorisation"
    ]
  },
  {
    id: "glissiere",
    ...
    specifications: [
      "Pour toute demande spécifique, consulter l'équipe technico-commerciale",
      "Épaisseur: de 40/25 12/10 à 50/30 15/10",
      "Formes en U, G ou renforcées selon application",
      "Joints d'étanchéité disponibles",
      "Perforations préparées pour fixation murale"
    ]
  },
  {
    id: "guide-portail",
    ...
    specifications: [
      "Pour toute demande spécifique, consulter l'équipe technico-commerciale",
      "Dimensions disponibles: 146, 220, 350",
      "Roulements à billes haute résistance",
      "Réglable en hauteur et largeur",
      "Compatible avec différentes épaisseurs de portail"
    ]
  },
  {
    id: "lame-finale",
    ...
    specifications: [
      "Pour toute demande spécifique, consulter l'équipe technico-commerciale",
      "Épaisseur: 1.2mm à 1.5mm",
      "Joint d'étanchéité inférieur disponible",
      "Système anti-soulèvement intégrable",
      "Compatible avec différents types de serrures"
    ]
  },
  {
    id: "lame-perforee",
    ...
    category: "lames_rideaux",
    specifications: [
      "Pour toute demande de personnalisation, consulter l'équipe technico-commerciale",
      "Épaisseur: (115mm) 0.8 et 1mm, (110mm et 125mm) 0.8 et 1mm",
      "Perforations régulières optimisées",
      "Compatible avec l'ensemble des systèmes de rideau",
  ...
  },
  {
    ...
    specifications: [
      "Pour toute demande spécifique, consulter l'équipe technico-commerciale",
      "Épaisseur: 0.7, 0.8 et 1mm",
      "Hauteur de lame: 115 mm",
      "Longueur: 4.4, 5 et 6m",
  ...
  },
  {
    ...
    specifications: [
      "Pour toute demande de personnalisation, consulter l'équipe technico-commerciale",
      "Épaisseur: 0.5, 0.6, 0.7, 0.8 et 1mm",
      "Longueur: 4.4, 5, et 6m",
      "Système d'emboîtement sécurisé",
      "Finition galvanisée ou laquée"
    ]
  },
  {
    id: "monorail",
    ...
    category: "lames_rideaux",
    specifications: [
      "Tableau de spécificités fourni avec détails sur la désignation, la matière et le poids",
      "Section en I ou en U selon applications",
      "Capacité de charge optimisée selon modèle",
      "Fixation plafond ou murale",
      "Compatible avec différents types de chariots roulants"
    ]
  },
  {
    id: "tube-rail",
    ...
    category: "lames_rideaux",
    specifications: [
      "Tableau de spécificités:",
      "- Tube Rail à Visser 3: Galvanisé 6, 8.928 kg",
      "- Tube Rail à sceller 3: Galvanisé 6, 22.752 kg",
      "Supports de fixation disponibles",
      "Finition lisse pour réduire l'usure des galets"
    ]
  }
];

export default lamesRideaux;
